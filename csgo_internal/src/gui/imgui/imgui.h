...
namespace ImGui
{
    ...
    IMGUI_API void          Render(ImDrawList* our_list = NULL);        // ends the Dear ImGui frame, finalize the draw data. You can then get call GetDrawData().
    ...
    IMGUI_API bool          TabButton(const char* label, int number, bool active, const ImVec2& size_arg, bool subtab);
